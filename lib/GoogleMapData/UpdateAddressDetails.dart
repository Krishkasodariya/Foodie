...
class _UpdateAddressDetailsState extends State<UpdateAddressDetails> {
  ...
  void initState() {
    ...
    super.initState();
    order = widget.snapshot[widget.index].ordertype;

    if (widget.snapshot[widget.index].addresstype == "Home") {
      currentindex = 0;
    } else if (widget.snapshot[widget.index].addresstype == "Work") {
      currentindex = 1;
    } else if (widget.snapshot[widget.index].addresstype == "Hotel") {
      currentindex = 2;
    } else {
      currentindex = 3;
    }
