import 'dart:convert';
import 'package:Pizza/Drawer/ViewTrackingOrder.dart';
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        FirebaseFirestore.instance.collection('trackingOrder').where(
            "uid", isEqualTo: loginController.userid).snapshots(),
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                        ...
                        child: order['cooking']
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage("images/FoodCooking.webp"),
                                fit: BoxFit.fill,)
                          ),
                        )
                            : Container(
                      ...
                      fit: BoxFit.cover)),
                              ...
                              order['processing'] ? ElevatedButton(
                                  style: ButtonStyle(
                                  ...
                                  onPressed: () {
                                    Navigator.push(context, PageTransition(
                                        ...
                                        child: ViewTrackingOrder(order: order,)));
